...
const BACKEND_URL = process.env.BACKEND_URL || 'http://localhost:18000'; // 确保端口与 FastAPI 匹配

export async function GET(request: NextRequest) {
  const destinationUrl = `${BACKEND_URL}/courses/`; // Assuming backend has a /courses endpoint
...
export async function POST(request: NextRequest) {
  const destinationUrl = `${BACKEND_URL}/course/`; // Assuming backend has a /course/ endpoint for POST
